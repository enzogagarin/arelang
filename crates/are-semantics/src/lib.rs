...
impl Builtin {
    ...
    pub const fn callee(self) -> &'static str {
        match self {
            ...
            Self::RequestQuery => "req.query",
            Self::RequestHeaders => "req.headers",
            Self::RequestCookies => "req.cookies",
...
pub fn builtin_by_callee(callee: &str) -> Option<Builtin> {
    match callee {
        ...
        "req.query" => Some(Builtin::RequestQuery),
        "req.headers" => Some(Builtin::RequestHeaders),
        "req.cookies" => Some(Builtin::RequestCookies),
