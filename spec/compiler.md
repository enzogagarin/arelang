...
- emit service, routes, body type, query type, headers type, cookies type, response type, status, typed path params, handler, local schema, and error mapper data in human or JSON form
